...
// Copyright(c) 2019 realvirtual GmbH - Usage of this source code only allowed based on License conditions see https://realvirtual.io/en/company/license
 ...
 [ExecuteAlways]
 [HelpURL("https://doc.realvirtual.io/extensions/page-4/path-system/curve")]
    ...
    // [HideInInspector] public LineRenderer Linerenderer;
     ...
     public void AttachLine()
     {
         ...
         AttachPathLine("Packages/io.realvirtual.starter/Runtime/PathSystem/Line.prefab", this.gameObject);
     ...
     public void AttachCurve()
     {
         ...
         AttachPathCurve("Packages/io.realvirtual.starter/Runtime/PathSystem/Curve.prefab", this.gameObject);
#if UNITY_EDITOR
