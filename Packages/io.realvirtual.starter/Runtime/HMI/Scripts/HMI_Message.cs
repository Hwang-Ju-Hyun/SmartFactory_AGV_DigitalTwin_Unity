...
namespace realvirtual
{
    ...
    [HelpURL("https://doc.realvirtual.io/components-and-scripts/scene-interaction/hmi-components-pro/hmi-message")]
    public class HMI_Message : BehaviorInterface
    {
        ...
        [Foldout("References")]public TextMeshProUGUI TextReference;
