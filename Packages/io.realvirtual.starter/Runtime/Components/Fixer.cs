...
namespace realvirtual
{
    ...
    [HelpURL("https://doc.realvirtual.io/components-and-scripts/picking-and-placing-mus/fixer")]
    [SelectionBase]
    #region doc
    ...
    //! https://doc.realvirtual.io/components-and-scripts/picking-and-placing-mus/fixer
    #endregion
    [ExecuteAlways]
    [Icon("Packages/io.realvirtual.starter/Editor/EditorAssets/EditorScriptIcons/Fixer Icon.png")]
    public class Fixer : BehaviorInterface, IFix, IMultiPlayer
    {
        ...
        public void OnTriggerEnter(Collider other)
        {
            ...
            if (mu != null)
            {
                // Ignore MUs that are part of a Source template
                if (mu.GetComponentInParent<Source>() != null)
                    return;
        ...
        public void Fix(MU mu)
        {
            ...
            // Ignore MUs that are part of a Source template
            if (mu.GetComponentInParent<Source>() != null) return;
